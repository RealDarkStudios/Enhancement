...
public enum ModArmorMaterial implements ArmorMaterial {
    ...
    DRAGONITE("dragonite", 50, new int[]{4, 7, 9, 4}, 18, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 5.0F, 0.3F, () -> Ingredient.ofItems(ModItems.DRAGONITE_INGOT)),
    TIN("tin", 13, new int[] {2, 5, 6, 2}, 10, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F, 0.0F, () -> Ingredient.ofItems(ModItems.TIN_INGOT));
